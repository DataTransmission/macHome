...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if not otherFees:
        otherFees = np.array([4.48,4.48,4.48]);  #% do not discount, other_fees ($4.11) should be the default
...
if __name__ == "__main__":
    import sys
    (actualPayment,estPayment) = myATT_monthly_est(124,[],3,[4.71,4.48,4.48]);
