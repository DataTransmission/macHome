***************************************************************************************
*	$Id: mon2yr.gs,v 1.22 2008/11/16 02:27:21 bguan Exp bguan $
...
while(zcnt<=_ze)
'set z 'zcnt
'yrtmp=ave(mn2yrtmp'vcnt',t+'offset1',t+'offset2')'
...
say ''
say '  Usage: mon2yr -v <var1> [<var2>...] [-n <name1> [<name2>...]] [-c <centered_on>] [-u <undef>] [-o <file>] [-p <path>]'
