...
*  if (lowres); file = 'lpoly_US.asc'; endif
  if (lowres); file = '/Users/rburgman/lib/grads/lpoly_lowres.asc'; endif
  if (mres)  ; file = '/Users/rburgman/lib/grads/lpoly_mres.asc'  ; endif
  if (hires) ; file = '/Users/rburgman/lib/grads/lpoly_hires.asc' ; endif
endif
if (type = 'O' | type = 'o') 
  if (lowres); file = '/Users/rburgman/lib/grads/opoly_lowres.asc'; endif
  if (mres)  ; file = '/Users/rburgman/lib/grads/opoly_mres.asc'  ; endif
  if (hires) ; file = '/Users/rburgman/lib/grads/opoly_hires.asc' ; endif
endif
