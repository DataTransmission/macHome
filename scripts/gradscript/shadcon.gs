***************************************************************************************
*	$Id: shadcon.gs,v 1.23 2010/05/10 21:04:27 bguan Exp bguan $
...
say '     <varmin> <varmax>: specify range of data to be plotted. <varmin> will be ignored if <varmax> is not specified. Defaults to actual range of data.'
say ''
