***************************************************************************************
*       $Id: colorbar.gs,v 1.1 2010/10/30 00:15:03 bguan Exp bguan $
...
sf=subwrd(arg,2)
if(posNstuff='-h'); usage(); return; endif
...
say ''
say '  Usage: colorbar [left|right|bottom|top[<offset>] [<scalingfactor>]]'
...
say ''
say '  "colorbar -h" prints this usage information.'
say ''
