***************************************************************************************
*	$Id: lagcorr.gs,v 1.41 2008/07/02 01:58:12 bguan Exp bguan $
*	Copyright (C) 2008 Bin Guan.
*	Distributed under GNU/GPL.
***************************************************************************************
function lagcorr(arg)
*
...
*
say '  Lag correlations between two variables.'
say ''
...
say '     <output>: Output variable. Defaults to "lagcorrout".'
say '               E.g., "set t 0" and then <output>(t-3) will be lag correlation when <input2> leads <input1> by 3 time steps.'
